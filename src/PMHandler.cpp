...
void PMHandler::preparePartitions(const Partition* p, Device *dev)
{
    ...
    if (sectorLastRoot > 0) {
        ...
        rootPartition->setFileSystem(FileSystemFactory::create(FileSystem::Ext4,
                                                               ...
                                                               -1, "Chakra"));
        PartitionTable::alignPartition(*dev, *rootPartition);
    ...
    if (sectorLastSwap > 0) {
        ...
        PartitionTable::alignPartition(*dev, *swapPartition);
    ...
    if (sectorLastVar > 0) {
        ...
        PartitionTable::alignPartition(*dev, *varPartition);
    ...
    if (sectorLastHome > 0) {
        ...
        PartitionTable::alignPartition(*dev, *homePartition);
